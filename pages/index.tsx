...
const PUBLIC_STAKING_DENOM = process.env.NEXT_PUBLIC_STAKING_DENOM || 'ustrd'
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    // const msgAny = {
    //   typeUrl: "/cosmos.stakeibc.liquid-stake",
    //   value: msgStake
    // }
    ...
    //   gas: "400",
    // };
    // const broadcastResult = signingClient.signAndBroadcast(
    //   walletAddress,
    //   [msgAny],
    //   defaultFee,
    //   "",
